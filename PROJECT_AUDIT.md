...
> **조치 현황 (2026-09-15 갱신, v9.1.1 반영):** ISSUE-001~007과 §5의 Confirmed/Likely Gap을 모두 수정했습니다. 이후 실제 한글 2022 COM 점검에서 추가 결함 5건(ISSUE-008~012)을 발견해 함께 수정했습니다. 상세 결과와 검증은 **§10 조치 결과**를 참고하세요. 아래 §1~§9는 감사 당시 기록을 그대로 유지합니다.

...
- 사전 점검 다이얼로그
- 결과 CSV/JSON 저장
- 동일 형식만 있는 경우의 건너뜀 결과
- 백업 옵션과 재시도 횟수 저장/복원
- 취소 후 종료/강제 종료 흐름
- 결과 폴더 열기와 실패 목록 저장 기능
- 실제 한글 COM 변환은 `HWP_COM_SMOKE_TEST_CHECKLIST.md` 기준으로 수동 확인
...
```text
# 현재 기능 파악
read specs/001-hwp-mate-reliability-ux/spec.md
read specs/001-hwp-mate-reliability-ux/tasks.md
# 잔여 구현
